            ...
            <div class="caja clearfix">
                <div class="extras">
                    <div class="orden">
                        ...
                        <input type="number" min="0" id="camisa_evento" size="3" name="pedido_camisa" placeholder="0">
                    </div>
                    <div class="orden">
                        <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML5, CSS, JavaScript, Firefox 7% dto.)</small></label>
